    ...
    <div className="space-y-6">
      ...
      {editingRequest && mounted && createPortal(
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-2xl max-w-2xl w-full my-8">
            {/* Modal Header */}
            ...
            <div className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 text-sm border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all resize-none placeholder-gray-400 dark:placeholder-gray-500"
                  rows={3}
              ...
              <div>
                ...
                {loadingAvailability ? (
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 max-h-48 overflow-y-auto p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-800">
                      ...
                      <button
                        ...
                        className={`px-3 py-2 text-xs rounded-lg transition-all font-medium ${
                          bookingDate === dateInfo.date
                            ...
                            : dateInfo.available
                            ? 'bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800 hover:border-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/30'
                            : 'bg-gray-100 dark:bg-gray-950 text-gray-400 dark:text-gray-500 border border-gray-200 dark:border-gray-800 cursor-not-allowed'
                        }`}
                      >
                        {dateInfo.label}
                      </button>
              ...
              <div>
                ...
                {availableTimes.length > 0 ? (
                  <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 max-h-40 overflow-y-auto p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-800">
