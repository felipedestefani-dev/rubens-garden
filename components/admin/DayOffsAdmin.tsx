    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">Carregando dias de folga...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Dias de Folga</h2>
      ...
      {dayOffs.length === 0 ? (
        <div className="text-center py-16 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
          ...
          <p className="text-gray-500 font-medium">Nenhum dia de folga cadastrado</p>
          <p className="text-gray-400 text-sm mt-1">Clique em "Adicionar Dia de Folga" para começar</p>
        </div>
      ) : (
            ...
            >
              ...
              {dayOff.reason && (
                <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-900">{dayOff.reason}</p>
                </div>
              )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-900">Novo Dia de Folga</h3>
                <button
                  onClick={() => {
                    setShowForm(false)
                    setFormData({ date: '', reason: '' })
