    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-white dark:bg-black flex flex-col transition-colors">
        ...
        <header className="sticky top-0 z-50 bg-white dark:bg-black border-b border-gray-100 dark:border-gray-900 transition-colors">
          <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-2.5 sm:py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Jardinagem e Paisagismo</p>
                </div>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
                ...
                <Link 
                  href="/admin" 
                  className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors px-1.5 sm:px-0"
                >
        ...
        <main className="flex-1 max-w-2xl mx-auto w-full px-3 sm:px-4 lg:px-8 py-6 sm:py-8 lg:py-12">
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            <div className="text-center space-y-1 sm:space-y-2">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-light text-gray-900 dark:text-gray-100">
                Solicite um serviço
              </h2>
            ...
            <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm">
              <ServiceRequestForm />
            </div>
          </div>
        </main>
